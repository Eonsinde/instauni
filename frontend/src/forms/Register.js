            ...
            <div className='container flex justify-center items-center mx-auto h-96'>
                ...
                <div className='basis-full md:basis-1/2'>
                    <form onSubmit={e => e.preventDefault()} className='flex flex-col px-2 w-10/12 md:w-9/12 lg:w-7/12 mx-auto'> 
                        ...
                        <div className='form-sect mb-7 md:mb-3 lg:mb-5'>
                            <input type='email' className='p-3 w-full border-solid border-2 border-gray-500 rounded-md shadow-sm focus:border-gray-200 focus:ring-4 focus:ring-gray-200 transition ease-in-out delay-150' placeholder='Email' />
                        </div>
                        <div className='form-sect mb-7 md:mb-3 lg:mb-5'>
                        ...
                        <div className='form-sect mb-7 md:mb-3 lg:mb-5'>
                            <input type='text' className='p-3 w-full border-solid border-2 border-gray-500 rounded-md shadow-sm focus:border-gray-200 focus:ring-4 focus:ring-gray-200 transition ease-in-out delay-150' placeholder='Level' />
                        </div>
                        <div className='form-sect mb-7 md:mb-3 lg:mb-5'>
                            <select className='p-3 w-full border-solid border-2 border-gray-500 rounded-md shadow-sm focus:border-gray-200 focus:ring-4 focus:ring-gray-200 transition ease-in-out delay-150'>
                        ...
                        <div className='form-sect mb-7 md:mb-3 lg:mb-5'>
                            <input type='password' className='p-3 w-full border-solid border-2 border-gray-500 rounded-md shadow-sm focus:border-gray-200 focus:ring-4 focus:ring-gray-200 transition ease-in-out delay-150' placeholder='Password'/>
                        </div>
                        <div className='form-sect mb-7 md:mb-3 lg:mb-5'>
