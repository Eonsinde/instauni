...
import igLogo from '../assets/images/instagram_logo.png';
...
const Home = () => {
    ...
    return (
            ...
            <div className='showcase-text text-gray-800 basis-1/2 space-y-6 mt-10 md:mt-0 md:text-left text-center'>
                ...
                <div className='flex md:justify-start md:items-center justify-center items-center space-x-2'>
                    <Link 
                        ...
                        className='bg-white border-2 border-app-green py-2 px-2 text-app-green hover:text-app-green dark:bg-transparent dark:border-white dark:text-white font-bold text-center inline-block lg:basis-2/6 md:basis-5/12 basis-3/6 rounded-md'
                    >
        ...
        <section className='about-section bg-gray-50 dark:bg-app-dark-opacity mt-6vh py-40 px-5'>
            <div className='container mx-auto'>
                <div className='about-header text-center mb-20'>
                    <h1 className='font-bold lg:text-5xl text-4xl mb-8 dark:text-white'>How it works</h1>
                    <p className='text-lg dark:text-slate-200'>Get started with 3 simple steps</p>
                </div>
                <div className='about-body flex md:flex-row flex-col items-center justify-center md:space-y-0 space-y-10'>
                    <div className='about-item basis-1/3 flex flex-col items-center justify-center space-y-10'>
                        ...
                        <div className='text-center text-lg'>
                            <p className='font-bold mb-2 dark:text-white'>Register / Login</p>
                    ...
                    <div className='about-item basis-1/3 flex flex-col items-center justify-center space-y-10'>
                        ...
                        <div className='text-center text-lg'>
                            <p className='font-bold mb-2 dark:text-white'>Make a Choice</p>
                            <p className='dark:text-slate-200'>
                    ...
                    <div className='about-item basis-1/3 flex flex-col items-center justify-center space-y-10'>
                        ...
                        <div className='text-center text-lg'>
                            <p className='font-bold mb-2 dark:text-white'>Follow Steps</p>
                            <p className='dark:text-slate-200'>
        ...
        <section className='faq-section py-40 px-5'>
            <div className='container mx-auto'>
                ...
                <div className='faq-body'>
                    <Collapse 
                        className='text-lg border-0 bg-white dark:bg-app-dark' 
                        defaultActiveKey={['']} 
                ...
                <div className='text-lg mt-20 text-center px-5 dark:text-white'>
        ...
        <footer className='text-center bg-gray-50 py-10 dark:bg-app-dark-opacity'>
